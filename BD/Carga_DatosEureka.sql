...
-- =============================================
-- Tabla auth
INSERT INTO auth (chr_usucodigo, vch_usulogin, vch_usupassword, vch_usuestado)
VALUES 
('U0001', 'ADMIN', 
 '835D6DC88B708BC646D6DB82C853EF4182FABBD4A8DE59C213F2B5AB3AE7D9BE', -- password: admin
 'ACTIVO');
 
INSERT INTO auth 
(chr_usucodigo, vch_usulogin, vch_usupassword, vch_usuestado)
VALUES 
('U0002', 'MONSTER', 
 '26591D262AE2C3D2320FF92AD90864D78E067022532041E8304688DB882E7C69', -- password: admin
 'ACTIVO');
...
--Tabla Usuario
INSERT INTO dbo.Usuario (chr_emplcodigo, vch_emplusuario, vch_emplclave, vch_emplestado)
VALUES 
('9999',  'internet',     LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'internet'), 2)), 'ACTIVO'),
('0001',  'cromero',      LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'chicho'), 2)), 'ACTIVO'),
('0002',  'lcastro',      LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'flaca'), 2)), 'ACTIVO'),
('0003',  'creyes',       LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'linda'), 2)), 'ANULADO'),
('0004',  'aramos',       LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'china'), 2)), 'ACTIVO'),
('0005',  'cvalencia',    LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'angel'), 2)), 'ACTIVO'),
('0006',  'rcruz',        LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'cerebro'), 2)), 'ACTIVO'),
('0007',  'ediaz',        LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'princesa'), 2)), 'ANULADO'),
('0008',  'csarmiento',   LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'chinita'), 2)), 'ANULADO'),
('0009',  'lpachas',      LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'gato'), 2)), 'ACTIVO'),
('0010',  'htello',       LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'machupichu'), 2)), 'ACTIVO'),
('0011',  'pcarrasco',    LOWER(CONVERT(VARCHAR(50), HASHBYTES('SHA1', 'tinajones'), 2)), 'ACTIVO');