...
-- =============================================
CREATE TABLE auth (
  chr_usucodigo VARCHAR(10) NOT NULL,
  vch_usulogin VARCHAR(50) NOT NULL,
  vch_usupassword VARCHAR(64) NOT NULL,
  vch_usuestado VARCHAR(15) DEFAULT 'ACTIVO',
  PRIMARY KEY (chr_usucodigo),
  CONSTRAINT UQ_vch_usulogin UNIQUE (vch_usulogin)
);
...
CREATE TABLE dbo.Usuario (
    ...
    vch_emplestado VARCHAR(15) NOT NULL,
    CONSTRAINT PK_Usuario PRIMARY KEY (chr_emplcodigo),
    CONSTRAINT FK_Usuario_Empleado FOREIGN KEY (chr_emplcodigo) 
        REFERENCES dbo.Empleado(chr_emplcodigo)
);

ALTER TABLE dbo.Usuario
ALTER COLUMN vch_emplclave VARCHAR(50) NOT NULL;
